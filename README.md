...
This is the part of the code that contains the hyperparameters and the deafault hyperparameters are clearly in the code.You can read about the hyperparameters from the report and chage them accordingly.
